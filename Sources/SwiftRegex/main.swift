...
//func parenthesize(expression: Substring) -> Substring {
//    var parenthesisCount = 0
//    var lastExpressionStart = 0
//
//    var addedOpeningParenthesisIndices = [Int]()
//    var addedClosingParenthesisIndices = [Int]()
//
//    var evaluatingNextExpression = false
//
//    for character in expression.enumerated() {
//        switch character.element {
//        case "(":
...
//                lastExpressionStart = character.offset
//            }
//        case "*":
//            addedOpeningParenthesisIndices.append(lastExpressionStart)
//            addedClosingParenthesisIndices.append(character.offset)
//            lastExpressionStart = character.offset + 1
//
//        case "|":
//            addedOpeningParenthesisIndices.append(lastExpressionStart)
//            addedClosingParenthesisIndices.append(character.offset)
//            lastExpressionStart = character.offset + 1
//            evaluatingNextExpression = true
//        }
//    }
//}
...
//func parseExpression(expression: Substring) -> ParsedExpression {
//    print(expression)
//
//    var parenthesisCount = 0
//    var subExpressionStart: Int?
...
//                let subExpression = expression[startIndex...endIndex]
//
//                parseExpression(expression: subExpression)
//
//                subExpressionStart = nil
//            }
//
